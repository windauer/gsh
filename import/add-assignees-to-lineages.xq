...
let $assigned-territories := doc('/db/apps/gsh/data/assignments/assignments.xml')//territory-id
for $lineage in doc('/db/apps/gsh/data/lineages/lineages.xml')//lineage[not(review) or review/status="unassigned"]
